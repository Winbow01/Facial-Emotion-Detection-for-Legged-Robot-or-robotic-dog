...
emotion_model.add(Conv2D(512, kernel_size=(3, 3), activation='relu', input_shape=(48, 48, 1)))
...
emotion_model.compile(loss='categorical_crossentropy', optimizer=keras.optimizers.Adam(), metrics=['accuracy'])
...
#
# Epoch 89/90
# 448/448 [==============================] - 46s 104ms/step - loss: 0.8419 - accuracy: 0.6462 - val_loss: 1.0603 - val_accuracy: 0.6104 - lr: 2.0000e-04
# Epoch 90/90
# 448/448 [==============================] - 46s 104ms/step - loss: 0.8452 - accuracy: 0.6466 - val_loss: 1.0690 - val_accuracy: 0.6062 - lr: 2.0000e-04